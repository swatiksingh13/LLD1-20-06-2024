package in.scaler.lld1200624.lld1class9.semaphoresolution;
...
public class Consumer implements Runnable {
    ...
    Consumer(Queue<Object> queue, String name, Semaphore producerSemaphore, Semaphore consumerSemaphore) {
        this.queue = queue;
        this.name = name;
